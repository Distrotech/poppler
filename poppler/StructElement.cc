...
static const AttributeMapEntry attributeMapCommonShared[] =
{
  ...
  ATTR_N(BorderColor,     gTrue,  isRGBColorOrOptionalArray4),
...
static const AttributeMapEntry attributeMapCommonBlock[] =
{
  ...
  ATTR_N(BBox,        gFalse, isNumberArray4),
  ATTR_D(Width,       gFalse, isNumberOrAuto, Auto),
  ATTR_D(Height,      gFalse, isNumberOrAuto, Auto),
...
static const AttributeMapEntry attributeMapCommonColumns[] =
{
  ...
  ATTR_N(ColumnGap,    gFalse, isNumberOrArrayN),
  ATTR_N(ColumnWidths, gFalse, isNumberOrArrayN),
  ATTR_LIST_END
};
...
static const AttributeMapEntry attributeMapCommonTableCell[] =
{
  ...
  ATTR_D(TPadding,     gTrue,  isPositiveOrArray4, Zero),
  ATTR_LIST_END
};
